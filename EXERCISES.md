...
Install docker containers for MongoDB and the Mongo-Express Webinterface. See [Get Github-Repo](https://github.com/Digital-Media/hyp3ue_t2/blob/master/INSTALL.md#get-repo) and [Docker INSTALL](https://github.com/Digital-Media/hyp3ue_t2/blob/master/INSTALL.md#docker) for that.

Create a cloud account for MongoDB Atlas. See [Cloud INSTALL](https://github.com/Digital-Media/hyp3ue_t2/blob/master/INSTALL.md#cloud) for that.
...
Use `db.users.drop();` to delete collection during testing.
